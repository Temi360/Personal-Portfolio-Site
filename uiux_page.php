...
<html>
     ...
     <script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/MotionPathPlugin.min.js"></script>
         ...
         <div class = "navbar">
                     <ul>
                         <li class = "jost" alt = "home icon" id = "homeIconNavbarDiv"><span onclick="transitionToPage('welcome_page.php')"><img alt = "home icon" src = "images/home_icon.svg"></span></li>
             ...
             <div class = "folderPageTitle"> UI/UX</div>
                <div class = "menuAndBackButton">
                <div style = "color: var(--darkDarkGrey)" id = "folderMenu"> Home > Work > Portfolio > <span style = "color: var(--black)"> UI/UX </span></div>
            </div>
            ...
            <img src = "images/rightChevron.svg">

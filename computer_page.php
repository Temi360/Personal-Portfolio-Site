    ...
    <script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/MotionPathPlugin.min.js"></script>
        ...
        <body> 
            ...
            <div class = "custom-cursor">
                ...
                <div class = "navbar">
                    <ul>
                        <li class = "jost" alt = "home icon" id = "homeIconNavbarDiv"><a href = "welcome_page.php"><img src = "images/home_icon.svg"></a></li>
                ...
                <object id = "computerElements" width ="700" height ="633.87" type="image/svg+xml" data="computerPageElements.svg"></object>
                </div>
